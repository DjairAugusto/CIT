...
export default function MenuAccount({ text, children }) {
    ...
    return (
        <div className="w-full bg-white rounded-lg shadow-md transition-all duration-500">
            ...
            <div
                className={`transition-all duration-500 overflow-hidden ${isOpen ? "max-h-96 p-4 border-t border-gray-200" : "max-h-0"}`}
            >
                {children}
            </div>
        </div>
