...
export default function HomePage() {
  ...
  return (
    ...
    <div className="absolute text-4xl top-10 left-1/4 text-[#42d0b3] text-3xl font-light font-solway">
        VILA PISANI
    </div>
    ...
    <div className="absolute bottom-5 right-5 text-[#777777] text-sm">
        ...
        <div className="p-6">
            ...
            {avisos.map((aviso) => (
                <div
                key={aviso.id}
                className={`flex items-center mb-3 cursor-pointer rounded-md p-2 ${
                    aviso.isUnread ? 'bg-[#F0FFF4] hover:bg-[#D9F6E3]' : 'hover:bg-gray-100'
                }`}
