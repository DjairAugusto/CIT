    ...
    return (
        <div className="bg-gray-50 min-h-screen p-6">
          ...
          <div className="flex flex-col items-center mb-4">
            <h2 className="text-2xl font-semibold text-gray-800 mb-2">Assembleias</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-4xl mx-auto">
            {[...Array(6)].map((_, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4 shadow-sm bg-white">
                <h3 className="text-lg font-semibold text-gray-700">Ata referente à Assembleia</h3>
                <p>XX/XX/XXXX</p>
                <div > <Link to="" className="hover:underline" style={{ color: '#42D0B3' }}>Visualizar</Link></div>
              </div>
            ))}
          </div>
        </div>
